...
\section{Die Aufgabenstellung}
 ...
 Im Rahmen dieser Ausarbeitung soll ein Python-Programm umgesetzt werden, welches "verwaschene" Trainingsdaten korrekt auf vier idealtypische Funktionen abbildet. Anschließend soll das gleiche Programm die Punkte eines Testdatensatzes anhand eines definierten, minimalen, statistischen Abstandswertes zu den gewählten idealtypischen Funktionen klassifizieren und jener Funktion zuordnen.
